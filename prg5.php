...
<nav style="background-color:#333;">
 ...
 <form method="POST">
        <table border="1" cellpadding="20px" align="center">
            <tr>
                <th colspan="2" style="background-color:black;color:white;">Create your account</th>
            </tr>
            <tr>
                <th>Account No</th>
...
$mysql = new mysqli("localhost","root","","con_db");
If(!$mysql) 
die("error");
...
else
{
    if($balance<500){
        ...
        mysqli_query($mysql, "INSERT INTO bank(accno,cust_name,cust_address,acc_type,balance) VALUES('$accno','$name','$address','$acc_type','$balance')");
