...
<body style="background-color: black;color: yellow;">
    ...
    <table border="1" style="text-align:left;">
        ...
        <tr>
            <th>Upload Picture</th><th><img src="<?php echo $row['picture']; ?>" height="60px" width="60px"><input type="file" name="file" ></th>
        </tr>  
        <tr>
...
$sql = mysqli_query($con,"UPDATE `passport` set `passno`='$passno',`fname`='$fname',`mname`='$mname',`lname`='$lname',`dob`='$dob',`nationality`='$nation',`address`='$addr',`gender`='$gender',`pic`='$fstore' WHERE passno='$passno'");
if($sql)
                    {
